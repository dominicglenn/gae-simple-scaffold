...
from babel import plural as babel_plural
...
_PICKLE_CLASS_WHITELIST = {'datetime': (datetime, ['date']),  # required by Babel
                           'babel.localedata': (babel_localedata, ['Alias']),  # required by Babel
                           'babel.numbers': (babel_numbers, ['NumberPattern']),  # required by Babel
                           'babel.dates': (babel_dates, ['DateTimePattern']),  # required by Babel
                           'babel.plural': (babel_plural, ['PluralRule']),  # required by Babel
...
sessions.default_config['secret_key'] = 'c8759b6f35694683af4836c5197262c2'
